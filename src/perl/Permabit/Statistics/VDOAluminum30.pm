...
##
package Permabit::Statistics::VDOAluminum30;
...
our $ALUMINUM_DEFINITIONS = {
                             'ReleaseVersion' => '133524',
                             'VDOStats' => [
                                            [
                                             'version',
                                             'constant',
...
my %PROPERTIES = prepareStatisticsProperties($ALUMINUM_DEFINITIONS,
                                             'VDOStats');

#############################################################################
# Creates a C<Permabit::Statistics::VDOAluminum30>, a variant of
# C<Permabit::Statistics::VDO> which covers the statistics in effect
# before 'head' became Aluminum.
#
# @return a new C<Permabit::Statistics::VDOAluminum30>
##
sub new {
  my $invocant = shift(@_);
