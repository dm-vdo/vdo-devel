...
##
package Permabit::Statistics::VDOMagnesium26;
...
my %PROPERTIES = prepareStatisticsProperties($MAGNESIUM_26_DEFINITIONS,
                                             'VDOStats');

#############################################################################
# Creates a C<Permabit::Statistics::VDOMagnesium26>, a variant of
# C<Permabit::Statistics::VDO> which covers the statistics in effect
# when Magnesium-rhel7.5 was branched from Magnesium.
#
# @return a new C<Permabit::Statistics::VDOMagnesium26>
##
sub new {
  my $invocant = shift(@_);
