...
##
package Permabit::Statistics::VDOChlorine;
...
our @EXPORT = qw($CHLORINE_DEFINITIONS);

our $CHLORINE_DEFINITIONS = {
                                'ReleaseVersion' => '0',
                                'StatisticsVersion' => '35',
                                'VDOStats' => [
                                                [
                                                  'version',
                                                  'constant',
...
my %PROPERTIES = prepareStatisticsProperties($CHLORINE_DEFINITIONS,
                                             'VDOStats');

#############################################################################
# Creates a C<Permabit::Statistics::VDOChlorine>, a variant of
# C<Permabit::Statistics::VDO> which covers the statistics in effect
# before 'head' became Chlorine.
#
# @return a new C<Permabit::Statistics::VDOChlorine>
##
sub new {
  my $invocant = shift(@_);
