...
# $self->_tryIllegal("logicalSize", -4 * $KB, "Usage:");
  ...
  $self->_tryIllegal("logicalSize", 4398046511108 * $KB, $dmsetupError, $kernelError);
  $self->_tryIllegal("logicalSize", ($maxUInt >> 20), $dmsetupError, $kernelError);

  $kernelError = "cannot be zero";
  $self->_tryIllegal("logicalSize",  ${maxUInt} * $KB, $dmsetupError, $kernelError);
  $self->_tryIllegal("logicalSize",  ${maxUInt} * $MB, $dmsetupError, $kernelError);
  $self->_tryIllegal("logicalSize",  ${maxUInt} * $GB, $dmsetupError, $kernelError);
  $self->_tryIllegal("logicalSize",  ${maxUInt} * $TB, $dmsetupError, $kernelError);
  $self->_tryIllegal("logicalSize",  ${maxUInt} * $PB, $dmsetupError, $kernelError);
  $self->_tryIllegal("logicalSize",  ${maxUInt} * $EB, $dmsetupError, $kernelError);
