...
our %PROPERTIES =
  (
   ...
   initialScenario       => "X86_FEDORA41_head",
...
sub propertiesSimpleMigration {
  return (
    ...
    intermediateScenarios => ["X86_FEDORA41_head"],
  );
}
...
sub propertiesMultipleMigration {
  return (
    ...
    initialScenario       => "X86_FEDORA41_head",
    # @ple The intermediate versions to go through
    intermediateScenarios => ["X86_FEDORA41_head", "X86_FEDORA41_head"],
  );
}
...
sub propertiesMigrateAndUpgrade {
  return (
    ...
    # @ple The intermediate versions to go through
    intermediateScenarios => ["X86_RHEL9_8.2.4-current", "X86_FEDORA41_head"],
  );
}
