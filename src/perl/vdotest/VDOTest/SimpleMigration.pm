...
our %PROPERTIES =
  (
   ...
   initialScenario       => "X86_FEDORA43_head",
...
sub propertiesSimpleMigration {
  return (
    ...
    intermediateScenarios => ["X86_FEDORA43_head"],
  );
}
...
sub propertiesMultipleMigration {
  return (
    ...
    initialScenario       => "X86_FEDORA43_head",
    # @ple The intermediate versions to go through
    intermediateScenarios => ["X86_FEDORA43_head", "X86_FEDORA43_head"],
  );
}
...
sub propertiesMigrateAndUpgrade {
  return (
    ...
    # @ple The intermediate versions to go through
    intermediateScenarios => ["X86_RHEL9_8.2.7-current", "X86_FEDORA43_head"],
  );
}
