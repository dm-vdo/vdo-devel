...
/**
 * vdo_get_component_encoded_size() - Get the size of the encoded state of the vdo itself.
 *
 * Return: The encoded size of the vdo's state.
 */
size_t vdo_get_component_encoded_size(void)
{
	return (sizeof(struct packed_version_number) + sizeof(struct packed_vdo_component_41_0));
}
 ...
 */
static inline struct packed_vdo_config pack_vdo_config(struct vdo_config config)
{
 ...
 */
static inline struct vdo_config unpack_vdo_config(struct packed_vdo_config config)
{
...
vdo_decode_component_41_0(struct buffer *buffer, struct vdo_component *component)
{
	struct packed_vdo_component_41_0 packed;
	int result;
 ...
 * Return: VDO_SUCCESS or an error.
 */
int vdo_decode_component(struct buffer *buffer, struct vdo_component *component)
{
	...
	result = vdo_validate_version(version, VDO_COMPONENT_DATA_41_0, "VDO component data");
	if (result != VDO_SUCCESS)
		return result;
