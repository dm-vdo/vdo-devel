...
static void abort_recovery(struct block_map_recovery_completion *recovery, int result)
{
...
static void
fetch_page(struct block_map_recovery_completion *recovery, struct vdo_completion *completion)
{
