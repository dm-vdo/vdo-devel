 ...
 */
slab_count_t __must_check vdo_compute_slab_count(physical_block_number_t first_block,
...
/**
 * vdo_get_slab_depot_encoded_size() - Get the size of the encoded state of a slab depot.
...
/**
 * vdo_encode_slab_depot_state_2_0() - Encode the state of a slab depot into a buffer.
 * @state: The state to encode.
 * @buffer: The buffer to encode into.
 *
 * Return: UDS_SUCCESS or an error.
 */
int vdo_encode_slab_depot_state_2_0(struct slab_depot_state_2_0 state, struct buffer *buffer)
{
...
/**
 * vdo_decode_slab_depot_state_2_0() - Decode slab depot component state version 2.0 from a buffer.
 * @buffer: A buffer positioned at the start of the encoding.
 * @state: The state structure to receive the decoded values.
 *
 * Return: UDS_SUCCESS or an error code.
 */
int vdo_decode_slab_depot_state_2_0(struct buffer *buffer, struct slab_depot_state_2_0 *state)
{
