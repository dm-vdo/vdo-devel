...
int __must_check
vdo_encode_slab_depot_state_2_0(struct slab_depot_state_2_0 state, struct buffer *buffer);

int __must_check
vdo_decode_slab_depot_state_2_0(struct buffer *buffer, struct slab_depot_state_2_0 *state);
...
block_count_t __must_check vdo_get_saved_reference_count_size(block_count_t block_count);
