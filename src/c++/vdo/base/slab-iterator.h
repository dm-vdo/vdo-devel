...
/**
 * vdo_iterate_slabs() - Return a slab_iterator initialized to iterate over an array of slabs with
 *                       a given stride.
...
/**
 * vdo_has_next_slab() - Check whether another vdo_slab would be returned by the iterator.
 ...
 *
 * Return: The next vdo_slab or NULL if the array of slabs is empty or if all the appropriate Slabs
 *         have been returned.
 */
