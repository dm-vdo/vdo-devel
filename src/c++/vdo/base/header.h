...
int __must_check vdo_encode_version_number(struct version_number version, struct buffer *buffer);

int __must_check vdo_decode_header(struct buffer *buffer, struct header *header);

int __must_check vdo_decode_version_number(struct buffer *buffer, struct version_number *version);
