...
/**
 * Check whether a data_vio is a read-modify-write.
 *
...
/**
 * Check whether a data_vio requires a FUA after doing its I/O.
 *
 * @param data_vio  The data_vio
 *
 * @return <code>true</code> if the data_vio requires a FUA
 **/
