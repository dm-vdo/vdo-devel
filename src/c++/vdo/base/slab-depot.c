...
/**
 * allocate_components() - Allocate those components of the slab depot which are needed only at
 ...
 */
static int allocate_components(struct slab_depot *depot, struct partition *summary_partition)
{
	zone_count_t zone;
