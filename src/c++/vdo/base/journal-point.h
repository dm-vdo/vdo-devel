 ...
 */
static inline bool vdo_is_valid_journal_point(const struct journal_point *point)
{
...
/**
 * vdo_are_equivalent_journal_points() - Check whether the first point is the same as the second
 *                                       point.
 * @first: The first journal point.
 * @second: The second journal point.
 *
 * Return: true if both points reference the same logical position of an entry in the journal.
 */
static inline bool vdo_are_equivalent_journal_points(const struct journal_point *first,
