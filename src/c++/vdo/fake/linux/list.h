...
static inline bool __list_add_valid(
	struct list_head *new __always_unused,
	struct list_head *prev __always_unused,
	struct list_head *next __always_unused)
{
	return true;
}
static inline bool
__list_del_entry_valid(struct list_head *entry __always_unused)
{
	return true;
}
#endif
...
/* hlist stuff from linux/list.h deleted */
