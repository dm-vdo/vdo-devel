...
EXPORT_SYMBOL_GPL(extend_delta_memory);
...
EXPORT_SYMBOL_GPL(get_delta_index_dlist_bits_used);
EXPORT_SYMBOL_GPL(get_delta_index_entry);
EXPORT_SYMBOL_GPL(get_delta_index_stats);
EXPORT_SYMBOL_GPL(get_index_session);
EXPORT_SYMBOL_GPL(get_index_stats);
EXPORT_SYMBOL_GPL(get_open_chapter_index_size);
...
EXPORT_SYMBOL_GPL(initialize_delta_memory);
EXPORT_SYMBOL_GPL(initialize_delta_memory_page);
...
EXPORT_SYMBOL_GPL(load_open_chapters);
...
EXPORT_SYMBOL_GPL(open_chapter_size);
...
EXPORT_SYMBOL_GPL(release_index_session);
...
EXPORT_SYMBOL_GPL(save_open_chapters);
...
EXPORT_SYMBOL_GPL(select_index_queue);
...
EXPORT_SYMBOL_GPL(uninitialize_delta_memory);
