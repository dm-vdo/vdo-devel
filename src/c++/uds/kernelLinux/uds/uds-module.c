...
EXPORT_SYMBOL_GPL(get_u16_le_from_buffer);
EXPORT_SYMBOL_GPL(get_u16_les_from_buffer);
EXPORT_SYMBOL_GPL(get_u32_le_from_buffer);
EXPORT_SYMBOL_GPL(get_u64_le_from_buffer);
EXPORT_SYMBOL_GPL(get_u64_les_from_buffer);
...
EXPORT_SYMBOL_GPL(put_s64_le_into_buffer);
EXPORT_SYMBOL_GPL(put_u16_le_into_buffer);
EXPORT_SYMBOL_GPL(put_u16_les_into_buffer);
EXPORT_SYMBOL_GPL(put_u32_le_into_buffer);
EXPORT_SYMBOL_GPL(put_u64_le_into_buffer);
EXPORT_SYMBOL_GPL(put_u64_les_into_buffer);
